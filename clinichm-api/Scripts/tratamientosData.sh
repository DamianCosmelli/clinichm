...
SUBCARPETA='dataseed'
ARCHIVO="$(dirname "$0")/$SUBCARPETA/Tratamientos_Plantilla.xlsx"
MODELO='Tratamientos'
...
if [ ! -f "$ARCHIVO" ]; then
    ...
    "Asegúrese de que existe la subcarpeta '$SUBCARPETA' con el archivo 'Tratamientos_Plantilla.xlsx'"
fi

# Mostrar información de la operación
echo "\n\033[1;34m📤 Importando datos de tratamientos\033[0m"
