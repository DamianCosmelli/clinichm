    ...
    <div className="w-full h-screen bg-fondo-contenedor relative overflow-hidden">
      <div className="flex flex-col gap-2 px-4 py-1 -mt-2 -ml-4">
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-navegacion">Nuevo empleado</span>
        </div>
        {/* Subtítulo y mensaje de éxito */}
        <div className="relative flex justify-between items-center">
          <span className="text-subtitulo mb-4 -mt-4">Nuevo empleado</span>
          {mensajeExito && (
      ...
      <FormularioEmpleado setMensajeExito={setMensajeExito} />
    </div>
  );
};
