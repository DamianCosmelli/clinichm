# Clinic Health Manager — Proyecto
...
- Backend  : [clinichm-api/README.md](clinichm-api/README.md) — API en .NET 8.
- Frontend : [clinichm-ui/README.md](clinichm-ui/README.md) — Interfaz web con React + Vite .
